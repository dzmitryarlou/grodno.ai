/*
  # Удаление требований авторизации для всех операций
  
  1. Изменения
    - Удаляем все политики RLS, требующие аутентификацию
    - Разрешаем все операции для всех пользователей
    - Упрощаем функции безопасности
    
  2. Безопасность
    - Полный доступ ко всем операциям без авторизации
